...
##groq_fund_commentary) smorgan@DESKTOP-LVSUQP3:/mnt/c/Users/smm25/Documents/GitHub/groq-streamlit$ streamlit run streamlit_csv_app.py --server.enableXsrfProtection false
# https://github.com/InsightEdge01/GroqMultiCSVChatPandasAI/blob/main/app.py