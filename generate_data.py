...
strategies = ["Equity", "Government Bonds", "High Yield Bonds", "Leveraged Loans", "Commodities", "Long Short Equity Hedge Fund", "Long Short High Yield Bond", "Private Equity"]
benchmarks = ["S&P 500", "Bloomberg Barclays US Aggregate Bond Index", "ICE BofAML US High Yield Index", "S&P/LSTA Leveraged Loan Index", "Bloomberg Commodity Index", "HFRI Equity Hedge Index", "HFRI Fixed Income - Credit Index", "Cambridge Associates Private Equity Index"]
